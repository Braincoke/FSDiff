...
public class ExportExclusionDialog extends Controller {
    ...
    public static void display(ComparisonWindowController windowController){
    ...
    public void export(){
        HashMap<ComparisonStatus, Boolean> options = new HashMap<>();
        options.put(ComparisonStatus.MATCHED, showMatched.isSelected());
        options.put(ComparisonStatus.MODIFIED, showModified.isSelected());
        options.put(ComparisonStatus.CREATED, showCreated.isSelected());
        options.put(ComparisonStatus.DELETED, showDeleted.isSelected());
        List<ComparisonTreeItem> filteredItems = windowController.getRootTreeItem().filterFiles(options, regex.getText(), true);
