package com.erwandano.fsdiff.hexviewer;

import com.erwandano.fsdiff.utils.HexDump;
import com.erwandano.fsdiff.utils.HexDumpLine;
    ...
    public void loadLines(File file, long offset, int nbLines){
        ...
        webEngine.getLoadWorker().stateProperty().addListener((obs, oldState, newState) -> {
            if (newState == Worker.State.SUCCEEDED) {
                webEngine.setUserStyleSheetLocation(getClass().getResource("HexDumpWebView.css").toExternalForm());
            }
        });
